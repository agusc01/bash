...
alias wifiinterface='iw dev | grep -i interface | xargs | cut -d " " -f2'
...
alias wifion='sudo kill -9 $(pgrep wpa_supplicant) || true; sudo rfkill unblock wlan; sudo ifup $(wifiinterface); refreshdbar'
alias wifireset='sudo kill -9 $(pgrep wpa_supplicant) || true; sudo rfkill unblock wlan; sudo ifdown $(wifiinterface); sudo ifup $(wifiinterface); refreshdbar'
alias wificheck='ping -c 1 -s 1 www.google.com'
alias wifiinfo='iw dev'
alias wifiinfo2='iw dev $(wifiinterface) link'
alias wifissid='iw dev | grep ssid | xargs | sed "s/ssid //"'
alias wifihelp='cat ~/.bash_aliases | grep "alias wifi" | cut -c 7- | grep -v wifihelp'
