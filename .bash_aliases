...
alias lf='lsd -alh | fzf | awk -v pwd="$(pwd)" "{print pwd \"/\" \$9}" | copyme'
alias lg='lsd -alh | grep'
alias lgd='lsd -alh | grep ^d'
alias lgf='lsd -alh | grep ^-'
alias lgi='lsd -alh | grep -i'
...
alias restartapache2='sudo systemctl stop apache2'
alias fd='fdfind'
alias man2='tldr'
...
alias ugit='~/git/scripts/recovery-configuration.sh'
